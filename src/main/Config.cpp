...
Config::Config() : NODE_SEED(SecretKey::random())
{
    ...
    TARGET_PEER_CONNECTIONS = 500;
    MAX_PENDING_CONNECTIONS = 500;
    MAX_ADDITIONAL_PEER_CONNECTIONS = 1000;
    MAX_OUTBOUND_PENDING_CONNECTIONS = 1000;
    MAX_INBOUND_PENDING_CONNECTIONS = 1000;
    ...
    HISTOGRAM_WINDOW_SIZE = std::chrono::seconds(3600);
